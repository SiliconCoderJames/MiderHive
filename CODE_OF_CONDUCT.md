...
We as members, contributors, and leaders pledge to make participation in the MiderHive
...
- Writing issues, discussions and patches in **Chinese or English** — both are equally welcome
...
This Code of Conduct applies within all community spaces (GitHub issues, discussions, pull
requests) and also applies when an individual is officially representing the community in public
spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the
maintainer privately — see **[SECURITY.md](SECURITY.md)** for the private contact channel (use
the same email; do not open a public issue for conduct reports). All complaints will be reviewed
